...
fn main() -> Result<()> {
    ...
    let model_id = match args.model_id {
        ...
        None => {
            let (version, size) = match args.model {
                ...
                WhichModel::W2_1_5bI => ("2", "1.5B-Instruct"),
    ...
    let filenames = match args.weight_files {
        ...
        None => match args.model {
            WhichModel::W0_5b | WhichModel::W2_0_5b | WhichModel::W2_1_5b | WhichModel::W1_8b | WhichModel::W2_1_5bI => {
